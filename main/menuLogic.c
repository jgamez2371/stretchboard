		...
		case KEY_RIGHT:
			switch(currentRow)
			{
				...
				case 2: // Bass ntensity
					...
					event = EV_UPDATE_INTENSITY;
					break;
				case 3: // Infrared intensity
					if(++menuPtr->settings->infrared > LED_INTENSITY_MAX)
					{
						menuPtr->settings->infrared = LED_INTENSITY_MAX;
					}
					event = EV_UPDATE_LED;
					break;
				default: // other lines
